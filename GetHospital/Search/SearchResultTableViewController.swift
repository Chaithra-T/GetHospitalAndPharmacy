...
class SearchResultTableViewController: UITableViewController {
    ...
    @IBAction func filterHospitals(_ sender: UIBarButtonItem) {
        ...
        searchRequest.pointOfInterestFilter = .some(MKPointOfInterestFilter(including: [MKPointOfInterestCategory.hospital]))
    ...
    @IBAction func filterPharmacies(_ sender: Any) {
        let searchRequest = MKLocalSearch.Request()
        searchRequest.pointOfInterestFilter = .some(MKPointOfInterestFilter(including: [MKPointOfInterestCategory.pharmacy]))
        search(using: searchRequest)
    }
